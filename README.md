...
> **📌 本 Fork 增强版** — 基于 [loks666/get_jobs](https://github.com/loks666/get_jobs)  
> - 🔄 **统一配置面板**：AI配置 + Boss/猎聘/51job/智联 四平台配置在同一页面管理，一键保存全部  
> - 🤖 **AI双向同步**：AI从技能介绍自动提取关键词/城市/薪资/岗位类型 → 一键同步到各平台配置  
> - 🚫 **统一黑名单系统**：跨平台共享黑名单（公司/HR/岗位/关键词），自动过滤四平台  
> - 🛡️ **Boss反检测增强**：WebGL指纹伪装、Canvas噪点、浏览器启动参数优化，解决登录闪回  
> - 🎨 **前端增强**：Tab状态持久化、AI助手标签整合（简历分析+对话）、Radix UI优化
<div align="center">
